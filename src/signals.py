...
class SignalsClass(QObject):
    ...
    train_model_switch_direction = pyqtSignal(int, bool) # used by track model to update the direction of the train (trainId, forwardOrBackward) - true or false
    ...
    trackmodel_update_occupancy = pyqtSignal(int, Line, int, bool, bool) # Used by train model to give track model info about a train's status on a particular block (trainId, Line, blockId, trainOrNot, forwardOrBackward) - true or false
