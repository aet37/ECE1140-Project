...
HOST = '3.23.104.34'
SERVER_PORT = 1234
HWTRACK_GET_HW_TRACK_CONTROLLER_REQUEST = b'104' #Change for my request numbers
HWTRACK_SEND_HW_TRACK_CONTROLLER_RESPONSE = b'105' #Change for my request numbers (Don't change anything else)
