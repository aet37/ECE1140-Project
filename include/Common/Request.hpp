...
enum class RequestCode : uint8_t
{
    ...
    GET_HW_TRAIN_CONTROLLER_REQUEST = 224,
    SEND_HW_TRAIN_CONTROLLER_RESPONSE = 225,
    GET_AUTHORITY = 226,
    GET_TRANSPONDER = 227, 
    SET_ENGINE_FAILURE = 228, 
    GET_ENGINE_FAILURE = 229, 
    SET_SIGNAL_FAILURE = 230,
    GET_SIGNAL_FAILURE = 231, 
    SET_BRAKE_FAILURE = 232, 
    GET_BRAKE_FAILURE = 233,
    SET_LIGHTS = 234, 
    GET_LIGHTS = 235, 
    SET_DOORS = 236, 
    GET_DOORS = 237, 
